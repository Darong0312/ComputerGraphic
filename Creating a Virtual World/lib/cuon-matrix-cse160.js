 ...
 */
 ...
 class Vector3 {
    ...
    static cross(other1, other2) {
        ...
        var a1 = other1.elements[0];
        var a2 = other1.elements[1];
        var a3 = other1.elements[2];
        var b1 = other2.elements[0];
        var b2 = other2.elements[1];
        var b3 = other2.elements[2];

        v3.elements[0] = a2*b3 - a3*b2;
        v3.elements[1] = a3*b1 - a1*b3;
        v3.elements[2] = a1*b2 - a2*b1;
        // Don't delete the return statement.
        return v3;
    }
